...
RETRIABLE_EXCEPTIONS = (errors.HttpError, IOError, errors.MediaUploadSizeError,
                        errors.MediaUploadSizeError, errors.ResumableUploadError,
                        errors.HttpLib2Error, OSError)
